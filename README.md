...
This pipeline component finder can be executed by submitting a job to Jenkins.  Simply go to this job on [jenkins](https://indy-jenkins.milliman.com/job/PRM_Pipeline_ENV_Generator/) and build a new release.  This will create and deploy a new pipeline_components_env file to the network.
